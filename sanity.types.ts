...
export type AllSanitySchemaTypes = Address | Blog | BlockContent | SanityImageCrop | SanityImageHotspot | Author | Slug | Blogcategory | Order | Product | Brand | Category | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
