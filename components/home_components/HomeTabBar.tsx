      ...
      <div className="flex items-center flex-wrap gap-3 text-sm font-semibold">
        {productType?.map((item) => (
          <button
            ...
            className={cn(
              "border border-shop_light_green/20 px-4 py-1.5 md:px-6 md:py-2 rounded-full hover:bg-shop_light_green hover:border-shop_light_green hover:text-white hoverEffect",
